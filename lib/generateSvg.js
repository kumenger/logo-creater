...
class Reactangle extends Log {
  ...
  <svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        ...
        < x="10" y="10" width="300" height="300"   fill="${this.ShapeColor}" stroke-width="1"/>
...
class Ellipse extends Log {
  ...
  <svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        ...
        <ellipse cx="25" cy="25" rx="25" ry="25" width="100" height="100" stroke="black" fill="${this.ShapeColor}"  stroke-width="1"/>
...
class Circle extends Log {
  ...
  render() {
   ...
   <svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        ...
        <circle cx="40" cy="40" r="30" width="180" height="180" stroke="black" fill="${this.ShapeColor}" stroke-width="5"/>
...
class Reactangle extends Log {
  ...
  <svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        ...
        <rect x="10" y="10" width="300" height="300"   fill="${this.ShapeColor}" stroke-width="1"/>
        <text text-anchor="middle"  font-size="15px"  x="100" y="80" fill="${this.textColor}">${this.text}</text>
      </svg>
